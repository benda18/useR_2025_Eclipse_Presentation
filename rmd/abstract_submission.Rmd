...
```{r Static Map, echo=TRUE, message=FALSE, warning=FALSE, prompt=F, results="hide"}
...
```{r Interactive Dashboard, eval=FALSE, message=FALSE, warning=FALSE, include=T, prompt=F, results="hide"}
...
```{r Get lon-lat automatically via ip address, eval=FALSE, message=FALSE, warning=FALSE, include=T, prompt=F, results="hide"}
